    ...
    return (
        <div className={styles.container}>
            ...
            {thesis.map((thesisElement, index) => {
                //alert(index);
                return <AssetThesisCard thesisDate={thesisElement.dateAddedReadable} thesisText={thesisElement.thesis} confidence={confidenceLevel[index]} action={thesisElement.action} key={index}/> 
            })}
