...
export const HomeSectionThree = () => {
    ...
    return (
        <div className={styles.container}>
            <div className={styles.textOne}>Track your buy, hold, sell, and watch decisions.</div>
            <div className={styles.textOne}>Confront how psychology helps and harms how you invest.</div>
